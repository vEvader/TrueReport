...
namespace TrueReport.App_Start
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/sweetalert").Include("~/Scripts/ThirdParty/sweet-alert.js"));

            bundles.Add(new ScriptBundle("~/bundles/interact").Include("~/Scripts/ThirdParty/interact-1.1.2.js"));

            bundles.Add(new StyleBundle("~/Content/css").Include(
                "~/Content/bootstrap.css",
                "~/Content/tr.designer.css",
